...
void dst_ac_decode_bit(unsigned char *b, int p, unsigned char *cb,
                     int fs, int Flush)
{
...
int dst_ac_get_ptable_index(long PredicVal, int PtableLen)
{
  int  j;
